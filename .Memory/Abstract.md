...
## 2026-09-14
- **Spec 优化部署重启** - 旧进程超时强停，新进程六秒就绪；停机缺口 B090 → [2026-09-14.md](2026-09-14.md)
- **Spec 任务驱动专家审查** - 通用任务先拆专家，写作四视角及旧规格补齐 → [2026-09-14.md](2026-09-14.md)
- **Spec 单主卡与容量续接** - 子任务主卡归并，跨轮历史与阶段验收保留 → [2026-09-14.md](2026-09-14.md)
...
- **Workflow停止交付栅栏** - 确认前等待运行owner静默，超时明确失败并阻止迟到卡片 → [2026-09-04.md](2026-09-04.md)
- **Warning Future所有权保真** - deadline前置耗尽保留in-flight，关闭不再误判或挂起 → [2026-09-04.md](2026-09-04.md)
- **ACP激活与结论保真收口** - 最新选择单写、退出栅栏、错误卡绑定及终答来源闭环 → [2026-09-04.md](2026-09-04.md)
## 2026-08-28
- **COT 合法帧不再误降级** - 补工具 START、推理重开与工具 ID 代际 → [2026-08-28.md](2026-08-28.md)
- **Codex终答回归主卡** - 保留可信 final_answer 相位，对账尾文不再覆盖结论 → [2026-08-28.md](2026-08-28.md)
## 2026-08-29
- **Codex终态严格对账** - 子代理/通用调用假失败收敛，execute dispatcher drain 待续 → [2026-08-29.md](2026-08-29.md)
## 2026-08-27
- **TraeX模型完整目录恢复** - config权威优先于active哨兵，24模型及档位恢复 → [2026-08-27.md](2026-08-27.md)
## 2026-08-20
- **COT默认简略过程流** - 借鉴lark-channel分层，工具摘要减载且主任务看板保留 → [2026-08-20.md](2026-08-20.md)
- **两名闲置Employee彻底清理** - 远端撤权后重置本地状态、工作区与凭据，空库重启通过 → [2026-08-20.md](2026-08-20.md)
- **Employee旧绑定回放兼容** - v1结构先丢弃废弃策略字段，线上5478帧完整恢复 → [2026-08-20.md](2026-08-20.md)
- **COT长任务分段续接** - UTF-8最终wire修复，容量边界自动续建过程段 → [2026-08-20.md](2026-08-20.md)
- **叠加执行安全层移除** - Shell/ACP/Workflow/Employee直连宿主，权限交给后端 → [2026-08-20.md](2026-08-20.md)
- **服务内同步重启自杀修复** - 进程树内restart自动委派脱离worker，外部同步语义保留 → [2026-08-20.md](2026-08-20.md)
## 2026-08-19
- **COT最终wire边界闭环** - 按官方4096字符与字符串时间戳预检，大结果不再击穿过程流 → [2026-08-19.md](2026-08-19.md)
- **ACP个人可信任务租约** - 管理员项目任务临时全权限，终态撤销失败即退休 → [2026-08-19.md](2026-08-19.md)
- **COT大结果稳定投递** - 标准wire、UTF-8分帧与真实错误码避免频繁误降级 → [2026-08-19.md](2026-08-19.md)
- **Spec伪导出退出Slash面板** - 仅下架无聊天交付闭环入口，其余八项保留 → [2026-08-19.md](2026-08-19.md)
- **未对账子代理终态保真** - 父卡终态收口，子代理未知不再伪标失败或取消 → [2026-08-19.md](2026-08-19.md)
- **COT降级不误报任务失败** - 过程旁路中性收口、主卡保持权威并继续执行 → [2026-08-19.md](2026-08-19.md)
- **ACP混合未完成自动续跑** - 子代理先对账、原计划冻结并恢复有界续做 → [2026-08-19.md](2026-08-19.md)
- **普通编程COT混合消息** - 原生过程流、任务结论卡与无损降级闭环 → [2026-08-19.md](2026-08-19.md)
## 2026-08-18
- **飞书SDK单文件导入缓存** - uv身份与Python ABI自动失效，mac readiness 55秒降至7秒 → [2026-08-18.md](2026-08-18.md)
- **聊天图片统一用户缓存** - 跨模式共享、全局哈希隔离并清除项目目录 → [2026-08-18.md](2026-08-18.md)
## 2026-08-17
- **编程降级不再静默等待** - CardKit缺权先回执并附申请链接，ACP静默有界终止 → [2026-08-17.md](2026-08-17.md)
- **首次Setadmin不再静默** - 统一bootstrap准入绕过未知私聊二次门禁并现场生效 → [2026-08-17.md](2026-08-17.md)
- **macOS停机导入栈消除** - launchd先卸载，运行时构造后再启用优雅SIGTERM → [2026-08-17.md](2026-08-17.md)
- **未配置管理员Help不再静默** - enforced私聊提供最小引导并附Slash申请链接 → [2026-08-17.md](2026-08-17.md)
- **Slash权限无损降级** - 官方一键申请链接、飞书提醒与后台自愈不再阻塞主服务 → [2026-08-17.md](2026-08-17.md)
...
- **ChannelSDK启动预算兼容** - Darwin spawn等待扩至30秒且ACK预算保持1.5秒 → [2026-08-17.md](2026-08-17.md)
- **macOS多进程门禁稳固** - spawn并发改用60秒共享预算并确保失败清理 → [2026-08-17.md](2026-08-17.md)
- **WS异步契约去时钟化** - 事件计数替代macOS负载敏感的100ms断言 → [2026-08-17.md](2026-08-17.md)
- **WS恢复时钟测试隔离** - 模块级时钟替身避免污染logging全局时间源 → [2026-08-17.md](2026-08-17.md)
- **Reporting锁注释契约恢复** - repair叶子锁恢复统一顺序声明并通过全树扫描 → [2026-08-17.md](2026-08-17.md)
- **本地密钥并发引导修复** - Darwin同名openat创建竞态有界重试，24并发稳定收敛 → [2026-08-17.md](2026-08-17.md)
- **隔离测试平台契约校准** - Linux bwrap用例平台化，macOS系统环境注入显式白名单 → [2026-08-17.md](2026-08-17.md)
- **Employee Channel退出竞态修复** - EOF短暂等候自然退出，准确区分崩溃与活进程断管 → [2026-08-17.md](2026-08-17.md)
- **主Bot审计快速恢复** - 382MiB全链流式验签，仅驻留锚定尾帧 → [2026-08-17.md](2026-08-17.md)
...
## 2026-08-14
- **A2A通信边界研究** - Employee/Team远程适配，ACP保留为内部后端 → [2026-08-14.md](2026-08-14.md)
- **dev发布与远程重启调度** - 13提交快进推送，rr绑定generation等待当前任务安全收尾 → [2026-08-14.md](2026-08-14.md)
## 2026-08-13
- **编程卡12块密度与续接去重** - 语义分页替代工具计数，旧卡只留一个下一卡提示 → [2026-08-13.md](2026-08-13.md)
- **Codex ACP与SDK升级修复** - 1.2.0/0.12.0升级并根治模型探测迟到帧错误 → [2026-08-13.md](2026-08-13.md)
- **Python3.13线程收尾补强** - 隔离测试线程与事件循环唤醒，全量4311通过 → [2026-08-13.md](2026-08-13.md)
- **/btw运行中只读旁路** - 避免仓库锁冲突且不打断主任务 → [2026-08-13.md](2026-08-13.md)
- **WS异步测试收尾稳定化** - 移除默认线程池等待导致的Python3.13假挂起 → [2026-08-13.md](2026-08-13.md)
- **WF结果账本可读化** - 结构化摘要、终态净化与无损wire分页 → [2026-08-13.md](2026-08-13.md)
...
- **共享Blob失败清理并发修复** - Ingress清理与Team retain同锁线性化，避免误隔离锚定引用 → [2026-08-12.md](2026-08-12.md)
- **Team共享Blob恢复闭环** - 三类Team引用随锚定重放保留，Ingress清理与锚定歧义失败关闭 → [2026-08-12.md](2026-08-12.md)
- **前六命令与恢复闭环** - 六项能力及并发恢复栅栏完成，全量4223通过 → [2026-08-12.md](2026-08-12.md)
- **动态多Agent编排V3方案** - 后端中立资源、动态角色拓扑、证据终态与十阶段迁移 → [2026-08-12.md](2026-08-12.md)
- **帮助契约对齐现役命令** - Employee 与 Workflow 帮助同步真实入口和单次池确认 → [2026-08-12.md](2026-08-12.md)
- **WF超时伪取消修复** - 尝试级取消隔离，生成预算600秒并补齐订阅事件ACK → [2026-08-12.md](2026-08-12.md)
- **终态诊断与子代理对账** - 详情按钮真实可用，历史脏记录不再误判任务失败 → [2026-08-12.md](2026-08-12.md)
- **性能加固阶段收口** - 队列有界、卡片生命周期、ACK热路径、WF取消域与ACP按需捕获 → [2026-08-12.md](2026-08-12.md)
## 2026-08-11
- **WF连续添加与选模提速** - 状态签名、精确防抖与30分钟目录缓存 → [2026-08-11.md](2026-08-11.md)
- **Grok原生ACP接入** - `/grok`直连、会话卡片与WF工具池完整支持 → [2026-08-11.md](2026-08-11.md)
- **WF表单200530回归修复** - 精确模型即时回调替代混合form，目录与添加恢复 → [2026-08-11.md](2026-08-11.md)
## 2026-08-10
- **WF确认后单卡贯穿** - 选择卡原位转生成摘要，取消与启动失败同卡终结并去重模型配置 → [2026-08-10.md](2026-08-10.md)
## 2026-08-09
- **Slock整体退役** - 删除群模式与专项测试，Team/员工记忆会话独立保留 → [2026-08-09.md](2026-08-09.md)
- **任务安全自动续做** - 安全默认与WF自动执行，危险授权仍失败关闭 → [2026-08-09.md](2026-08-09.md)
- **WF真实租户验收门禁** - 多卡证据绑定、冻结时序与显式live入口 → [2026-08-09.md](2026-08-09.md)
## 2026-08-08
- **WF消息卡终态全显与容量续接** - 安全结果投影、固定单步槽与双入口共享分页投递 → [2026-08-08.md](2026-08-08.md)
- **维护待办五项闭环** - 快照恢复、空闲短路、布尔合同与CardKit生命周期 → [2026-08-08.md](2026-08-08.md)
- **维护清单证据化收敛** - 删除已分层/已接受/已覆盖条目并校准Ruff基线 → [2026-08-08.md](2026-08-08.md)
- **WF评审权限与终态卡修复** - Traex argv安全兼容、评审分类与陈旧停止幂等 → [2026-08-08.md](2026-08-08.md)
- **Codex子任务终态根治** - 兼容快照、跨turn账本与确认边界统一 → [2026-08-08.md](2026-08-08.md)
- **Codex迟到终态卡片回放** - 对账账本与主卡投影统一且隔离新任务 → [2026-08-08.md](2026-08-08.md)
- **Codex权威终态Rollout兜底** - 精确会话映射并限制单轮对账 → [2026-08-08.md](2026-08-08.md)
- **Codex终态日志实证闭环** - 真实rollout重放归零三项误判并完成扩展验证 → [2026-08-08.md](2026-08-08.md)
- **Codex终态剩余边界闭环** - 跨任务隔离、子卡换代并发与全量门禁全部收口 → [2026-08-08.md](2026-08-08.md)
- **Codex worker角色覆盖修复** - 自定义角色精确覆盖内置worker，新会话生效 → [2026-08-08.md](2026-08-08.md)
- **Codex子代理超时收尾** - 禁止等待式收尾、单轮Goal边界与取消终态归一 → [2026-08-08.md](2026-08-08.md)
- **WF编排默认免选** - /wf 自动走默认编排路径，保留确认卡与可回退修改 → [2026-08-08.md](2026-08-08.md)
## 2026-08-07
- **普通编程任务可见性** - 子任务原因、命令两段式与重复执行态收口 → [2026-08-07.md](2026-08-07.md)
- **Codex Luna节流配置** - Standard保留、单Luna Max worker与非嵌套边界 → [2026-08-07.md](2026-08-07.md)
- **TUI2ACP后端与测试清退** - 入口运行时依赖全删，通用响应回归迁移 → [2026-08-07.md](2026-08-07.md)
- **ACP子代理终态对账** - 旧快照归并、单次对账与超时退休闭环 → [2026-08-07.md](2026-08-07.md)
## 2026-08-06
- **TTADK与退役模式清退** - 后端全删、入口墓碑与通用Git边界保留 → [2026-08-06.md](2026-08-06.md)
- **Codex Goal超时收口** - 生命周期分离、收尾先暂停并保真超时 → [2026-08-06.md](2026-08-06.md)
## 2026-08-05
- **Worktree执行模式移除** - 代码入口卡片文档清退，保留Git工作树边界 → [2026-08-05.md](2026-08-05.md)
- **重启门禁测试隔离** - pytest不再覆盖线上participation，恢复rr预检 → [2026-08-05.md](2026-08-05.md)
- **Deep单主卡与消息洪泛修复** - 运输分流、代际熔断与子代理主卡归并 → [2026-08-05.md](2026-08-05.md)
- **员工恢复后台化** - 主WS先ready、员工准入失败关闭且安全drain → [2026-08-05.md](2026-08-05.md)
- **测试资产深度精简** - 两轮净删206函数，伪契约改真边界并收口全套失败 → [2026-08-05.md](2026-08-05.md)
## 2026-08-01
...
- **Team清理证据耐久补强** - unlink后fsync失败重建或内存保留 → [2026-07-31.md](2026-07-31.md)
- **受管群恢复出口补偿** - legacy证据延迟消费，Team ACTIVE清理可重试 → [2026-07-31.md](2026-07-31.md)
- **受管群残留恢复闭环** - VALID复用、UNKNOWN阻断，legacy校验后收养解套 → [2026-07-31.md](2026-07-31.md)
- **受管群四轮加固** - 单进程generation CAS、原子建绑与远端复核 → [2026-07-31.md](2026-07-31.md)
- **受管群三轮加固** - 统一启动saga、撤销取消与辅助存储耐久边界 → [2026-07-31.md](2026-07-31.md)
- **受管群二轮加固** - crash saga、不确定外呼与迁移歧义；员工轮换源阻塞 → [2026-07-31.md](2026-07-31.md)
- **受管群审计加固** - flock事务、pending撤销与Owner生产控制面 → [2026-07-31.md](2026-07-31.md)
- **受管群原子生命周期** - Registry重放、单grant与建群先ACTIVE后欢迎 → [2026-07-31.md](2026-07-31.md)
- **受管群失败关闭补强** - 完整Saga CAS，已建远端群保留但不授信 → [2026-07-31.md](2026-07-31.md)
- **Claude CLI 选模真实落地** - Direct/Engine argv与1M环境绑定，失败保留旧状态 → [2026-07-31.md](2026-07-31.md)
- **零打断信任动作矩阵** - 三域解析、因果员工续作与revision派发门禁 → [2026-07-31.md](2026-07-31.md)
- **Direct ACP 事务选模** - 排队失败不写状态、线程退出原生取消 → [2026-07-31.md](2026-07-31.md)
- **执行通道命令目录合同** - 80条Owner命令统一解析、健康分离、保护显式入口 → [2026-07-31.md](2026-07-31.md)
- **Agent平台三信任域轻量化** - Owner私聊管扩权，自建群项目内零审批直执 → [2026-07-31.md](2026-07-31.md)
- **子Agent进展与事件ACK** - 稳定线程同步、真实终态与P2P事件止重试 → [2026-07-31.md](2026-07-31.md)
- **体验模式恢复入站** - 单管理员、私聊与各类群直接可用，测试脱离生产模式 → [2026-07-31.md](2026-07-31.md)
- **普通编程长卡容量续接** - 先可见后冻结、完整终答与终态资源闭环 → [2026-07-31.md](2026-07-31.md)
- **Worktree终态真实门禁** - 硬超时、确认取消、证据评审与自动合并阻断 → [2026-07-31.md](2026-07-31.md)
- **入站默认拒绝复审收口** - 四层规范事实校验、阶段化原子提交与跨进程RMW → [2026-07-31.md](2026-07-31.md)
- **WF执行绑定与评审承诺** - 冻结RunSpec贯穿调用，Reviewer真终态与证据失败关闭 → [2026-07-31.md](2026-07-31.md)
- **Spec完成判定默认拒绝** - 无效判定同绑定有界重试，耗尽暂停待人工确认 → [2026-07-31.md](2026-07-31.md)
- **辅助Agent默认拒绝工具** - 协调/分类/摘要统一deny-all且不影响员工执行 → [2026-07-31.md](2026-07-31.md)
- **Agent平台合同与安全姿态** - 全计划依赖账本、产品真相和默认拒绝姿态落地 → [2026-07-31.md](2026-07-31.md)
- **测试套件语义去重** - 净减230项并将真实等待分层，修复Timer退出竞态 → [2026-07-31.md](2026-07-31.md)
- **高置信测试二次删减** - 删除55函数/58项，保留16项安全替换候选 → [2026-07-31.md](2026-07-31.md)
- **耗时与WF边界补强** - TTL/空完成冻结，Auto与显式评审互斥 → [2026-07-31.md](2026-07-31.md)
- **Agent平台演进计划** - 保护直连/Deep/Spec，单用户直开并收敛接入、编排与主动任务 → [2026-07-31.md](2026-07-31.md)
- **WF卡片洪泛修复** - origin贯穿、newest-wins与生命周期静默 → [2026-07-31.md](2026-07-31.md)
## 2026-07-30
- **任务卡实时耗时页脚** - 全卡更新同步时分秒，跨天显示且终态冻结 → [2026-07-30.md](2026-07-30.md)
- **WF评审重复选Traex修复** - 同步骤切换幂等并保留模型级联面板 → [2026-07-30.md](2026-07-30.md)
- **Slock空角色启动告警降级** - 合法禁用改为INFO并保持权限语义 → [2026-07-30.md](2026-07-30.md)
- **Agent部门产品收敛计划** - 26项门禁化路线统一安全、控制面、运行时与发布证据 → [2026-07-30.md](2026-07-30.md)
- **普通编程计划自动续做** - pending计划同会话有界续跑，真门禁转等待而非失败 → [2026-07-30.md](2026-07-30.md)
- **普通编程卡片分段思考** - 主/子代理/终答分块并保持流式分页安全 → [2026-07-30.md](2026-07-30.md)
## 2026-07-29
- **编程超时收尾与卡片安全** - 预留终态、会话退休并净化子任务错误 → [2026-07-29.md](2026-07-29.md)
## 2026-07-28
- **Team恢复通知作用域** - 延迟恢复并原子重建收件人，失败保持可重试 → [2026-07-28.md](2026-07-28.md)
- **团队员工查询与重启自愈** - 统一Journal事实、准入通知与Channel/Actor恢复 → [2026-07-28.md](2026-07-28.md)
- **WF有界pipeline与结构契约** - 避免无界扇出和9倍重试，类型失配失败关闭 → [2026-07-28.md](2026-07-28.md)
- **Help卡片格式优化** - 主帮助去版本与按钮，WF帮助改结构化折叠卡 → [2026-07-28.md](2026-07-28.md)
- **子任务错误详情折叠** - 失败摘要常显，长JSON/测试输出/调用栈默认收起 → [2026-07-28.md](2026-07-28.md)
## 2026-07-27
- **普通编程子任务单主卡** - 删除重复空子卡，摘要/输出/图片统一进入主卡 → [2026-07-27.md](2026-07-27.md)
- **Codex历史失败终态误判** - 已终止失败不再覆盖最终成功，未决工具继续默认拒绝 → [2026-07-27.md](2026-07-27.md)
- **主Agent斜杠指令面板** - 80条主命令自动对账并保持Channel入站与失败隔离 → [2026-07-27.md](2026-07-27.md)
- **Codex选模修复收尾** - 迁移违规计划路径并补齐全量与部署门禁 → [2026-07-27.md](2026-07-27.md)
## 2026-07-24
- **Codex选模预热与门禁恢复** - 后台预热模型能力，系统命令按run幂等解锁 → [2026-07-24.md](2026-07-24.md)
- **编程终态与并发安全巡检** - 子任务终态、媒体归属、按钮防重放与Context投影竞态收口 → [2026-07-24.md](2026-07-24.md)
- **子任务卡片移动端收敛** - 隐藏内部ID、折叠整体进度并去除重复元数据 → [2026-07-24.md](2026-07-24.md)
- **Deep假子任务路由修复** - execute输出不再因源码标记误生成子卡 → [2026-07-24.md](2026-07-24.md)
- **ACP图片产物卡片流** - 安全上传、流内去重与Deep/Spec图片展示 → [2026-07-24.md](2026-07-24.md)
## 2026-07-22
- **编程卡片执行流时间线** - 分析与工具按序统一、当前动作可见且完成答案优先 → [2026-07-22.md](2026-07-22.md)
- **过程摘要折叠内列表化** - 工具边界保真分项并统一扫读层级 → [2026-07-22.md](2026-07-22.md)
- **编程卡片过程摘要收敛** - 工具边界不再切碎摘要并聚合活动历史 → [2026-07-22.md](2026-07-22.md)
- **普通编程Channel流式卡** - 官方SDK接管入站与CardKit增量投递 → [2026-07-22.md](2026-07-22.md)
## 2026-07-21
- **Deep卡片warning瀑布修复** - stale页单调替代与活动phase锚点保留 → [2026-07-21.md](2026-07-21.md)
## 2026-07-20
- **员工旧话题上下文污染修复** - 隔离不可映射历史om记录并保留当前消息审计 → [2026-07-20.md](2026-07-20.md)
- **员工话题派发死循环修复** - 区分 omt 话题ID与 om 根消息并恢复旧账本 → [2026-07-20.md](2026-07-20.md)
- **测试套件分层瘦身** - 去重低信号用例、快慢门禁与 AST 清单审计 → [2026-07-20.md](2026-07-20.md)
## 2026-07-19
- **员工群账本与幽灵Slock修复** - 群命令隔离、跨Bot身份归一、卡片结构及删群marker闭环 → [2026-07-19.md](2026-07-19.md)
- **员工TraeX独立状态修复** - 私有TRAE_HOME、根约束、持久ACP目录及离职擦密 → [2026-07-19.md](2026-07-19.md)
## 2026-07-18
- **TraeX常驻与Outbox幂等** - 模型选择单权威、非变异健康检查及快照GC幂等 → [2026-07-18.md](2026-07-18.md)
- **员工System历史修复** - 官方空sender归一化并对齐Direct群账本降级键 → [2026-07-18.md](2026-07-18.md)
- **员工群Blob竞态修复** - 群上下文先投影再派发GC，共享引用保留并恢复误隔离blob → [2026-07-18.md](2026-07-18.md)
- **持久员工规划缺口收口** - Actor/Team/群账本/CLI隔离/状态与发布门完整接入 → [2026-07-18.md](2026-07-18.md)
## 2026-07-17
- **员工群成员启动对账** - 官方is_in_chat清理陈旧群事实并对未知状态降级拒绝 → [2026-07-17.md](2026-07-17.md)
- **员工Channel重连卡死自愈** - STARTING超时触发持久revalidation与新generation → [2026-07-17.md](2026-07-17.md)
- **Lark连接日志脱敏并安全重启** - 禁止SDK记录WebSocket凭据URL、轮换旧日志并验证Actor/Coordinator在线 → [2026-07-17.md](2026-07-17.md)
- **常驻员工默认切流** - Actor/Coordinator 默认启用与真实租户验收模板 → [2026-07-17.md](2026-07-17.md)
- **员工切流门禁就绪** - shadow 审计与持久模式真实租户验收清单 → [2026-07-17.md](2026-07-17.md)
- **员工运行时状态卡** - 双状态、partial 诊断、管理员安全恢复动作 → [2026-07-17.md](2026-07-17.md)
- **员工恢复迁移收口** - 有序恢复、反向关闭、Fire fence、幂等 workspace 迁移 → [2026-07-17.md](2026-07-17.md)
- **员工群选择性唤醒** - Direct邮箱、闲聊零调用、贡献因果与Bot防循环 → [2026-07-17.md](2026-07-17.md)
- **持久团队协调器** - 加密任务图、动态分配、模型会话与四点恢复 → [2026-07-17.md](2026-07-17.md)
- **员工执行知识Wiki** - 来源先行、异步编译、索引查询与完整性lint → [2026-07-17.md](2026-07-17.md)
- **群账本与上下文降级** - 跨Bot去重、加密事件与Ordering局部降级 → [2026-07-17.md](2026-07-17.md)
- **员工Actor与会话租约** - Journal邮箱、Session复用、idle回收与三档切换 → [2026-07-17.md](2026-07-17.md)
- **员工Bootstrap与路径隔离** - 跨后端digest、Codex HOME与读写根分离 → [2026-07-17.md](2026-07-17.md)
- **员工知识工作区投影** - no-follow原子生成、lint与激活前门禁 → [2026-07-17.md](2026-07-17.md)
- **Hire完整身份固化** - 角色模板、能力权限白名单与资料卡预览 → [2026-07-17.md](2026-07-17.md)
...
## 2026-07-16
- **Team员工自动恢复与群状态修复** - 非阻塞路由、READY自动激活与成员事实回放自愈 → [2026-07-16.md](2026-07-16.md)
- **员工群内@静默与跨App身份修复** - bot身份、pending提示、union ACL与换代恢复 → [2026-07-16.md](2026-07-16.md)
- **Team假受理竞态修复** - 准入前就绪快照、终态重放拒绝与可行动提示 → [2026-07-16.md](2026-07-16.md)
- **Deep终态刷新与权威总耗时修复** - CardKit实体审计坐标、单条兜底与项目级终态计时 → [2026-07-16.md](2026-07-16.md)
- **Deep卡片顺序分页重设计** - 版本栅栏、追加分页、主任务与Subagent独立卡 → [2026-07-16.md](2026-07-16.md)
- **历史维护条目证据化处置** - 修复并发与生命周期缺陷，外部验收迁入运行档 → [2026-07-16.md](2026-07-16.md)
- **Deep卡片问题摘要抬头** - 15字摘要替代首轮标题 → [2026-07-16.md](2026-07-16.md)
- **Team超时竞态收敛加固** - Context前撤销、deadline终态保真与CAS真回归 → [2026-07-16.md](2026-07-16.md)
## 2026-07-15
...
- **已有应用激活身份修复** - union_id跨应用验证、旧Hire绑定与Fire恢复幂等 → [2026-07-15.md](2026-07-15.md)
- **团队模式真实员工闭环** - 修复Slash/卡片/恢复/退役并接入Journal三段员工协作 → [2026-07-15.md](2026-07-15.md)
## 2026-07-14
- **注册400日志误报修复** - 设备授权pending是正常400，端点级httpx过滤+状态once去重+准确等待文案 → [2026-07-14.md](2026-07-14.md)
- **员工存储HOME软链接修复** - 仅规范化受管HOME前缀，保留子目录nofollow边界并完成真实重启验收 → [2026-07-14.md](2026-07-14.md)
- **内置员工启动能力** - 本地密钥、官方智能体preset、员工出站与Channel回退 → [2026-07-14.md](2026-07-14.md)
...
- **员工Ingress加密持久化** — 独立Blob+Journal ACK、冲突/恢复/故障隔离与EI-IPC-01真实进程证据落地 → [详细记录](2026-07-13.md)
- **Durable Ingress严格合约** — 冻结metadata/payload/ACK/attempt与本地EI证据，补齐secret别名和队列层级 → [详细记录](2026-07-13.md)
...
- **Canonical冻结员工域** — 统一 `agent_id`、完整身份字段与 Bot 凭证引用，兼容旧输入别名且投影不再输出旧 ID → [详细记录](2026-07-12.md)
...
## 2026-06-02
- **Traex ACP 工具接入** — 新增 `/traex` ACP 编程工具，接入模型选择、普通编程、Deep/Spec/Worktree 身份与卡片 UI；相关回归 1065 passed，validate/diff-check 通过 → [详细记录](2026-06-02.md)
## 2026-05-27
- **Slock Review 修复** — 修复 Slock dispatch 跨群派单风险、wake_policy 归一化/配置校验、agent @mention token 路由、队友 roster prompt 字段清洗，并同步 `/task assign` deprecated 契约；直接触达 267 passed，Slock 通配剩 4 个既有非本轮失败 → [详细记录](2026-05-27.md)
## 2026-05-26
...
## 2026-05-19
- **Slock 升级协议 UX 闭环** — `_resolve_escalation()` 重写：权限校验（`admin_user_ids ∪ channel.owner_id`）、resolution 白名单（`value in escalation.options`）、`update_card()` 就地更新为绿色 resolved 卡片、card 失败时 fallback 文本、重复点击 graceful 处理。`SlockChannel` 新增 `owner_id`，`engine.get_escalation()` 供 handler 层校验。
- **Slock 4 项 Review 缺陷修复** — (1) `activate_channel()` marker_data 补齐 `owner_id` 持久化；(2) `get_escalation()` 返回 `copy.copy(esc)` 浅拷贝防止外部突变，`EscalationRequest.options` 冻结为 `tuple[str, ...]`（`__post_init__`）；(3) `_resolve_escalation()` 仅在 `card_updated == False` 时发送 fallback 文本，消除成功路径冗余消息；(4) `settings.py` 兼容 model_validator 改为 `os.environ.get("SLOCK_TEAM_NAME_PREFIX")` 直接读取，解决 Pydantic BaseSettings 不传递未知 env 给 `data` dict 的限制，发出 `DeprecationWarning` 并映射到 `slock_team_name_suffix`。全量 7131 passed（1 个 pre-existing `spec_max_cycles` 配置漂移无关）→ [详细记录](2026-05-19.md)
- **Slock 生产就绪加固：有界并发 + 队列超时 + 任务上限 + 安全错误 + 双语升级** — (1) `BoundedExecutor` 包装 `ThreadPoolExecutor`，`max_queue_size` 限流、`enqueue_time` 跟踪队列等待超时；(2) Settings 新增 `slock_max_workers`/`slock_max_queue_size`/`slock_queue_wait_timeout`/`slock_max_open_tasks` 带 Pydantic `Field(ge=...)` 校验；(3) `add_task()` 返回 `Optional[SlockTask]`，超限时发安全错误卡而非抛异常；(4) `_safe_error_message()` 防止内部路径泄漏到用户可见卡片；(5) 升级协议 resolution options 改为双语 `("继续执行 Resume", "跳过 Skip", "终止 Abort")`，`_resolve_escalation()` 按空格分割匹配；(6) `_deduplicate_permissions()` 消除重复权限请求。测试隔离修复：`test_slock_task_execution.py` 两处 `_make_engine` 补 `memory_base_path=str(tmp_path)` 避免加载全局持久化任务；`bounded_executor.py` 补 leaf lock 注释满足 `test_lock_ordering` 契约。全量 7233 passed, 3 warnings → [详细记录](2026-05-19.md)
- **Slock 架构加固：异步执行统一 + 事件驱动取消 + Rate-Limit** — (1) `execute_parallel` 超时改用 `futures_wait` 事件驱动等待替代 `time.sleep`；(2) EscalationManager Retry 路径异步化（get_executor_fn → executor.submit）；(3) Handler 提取 `_execute_async()` 消除 ~160 行重复代码；(4) 非管理员 rate-limit 滑动窗口（`slock_assign_rate_limit` 配置）防止 DoS。全量 7288 passed → [详细记录](2026-05-19.md)
- **Slock API 契约修复 + 测试加固** — (1) `_check_queue_wait_timeout` 增加 `if future is None: return False` early return 修复同步 executor 竞态；(2) `engine.add_task()` 和 `TaskBoardManager.add_task()` docstring 明确标注 Optional 返回契约；(3) 8 个测试文件增强：Zero HI auto_approve 验证、Status Refresh/Stop 按钮、Passthrough 无副作用（13 tests）、L1 跨群人格一致性（4 tests）、全角色色彩映射（9 tests）。全量 7326 passed → [详细记录](2026-05-19.md)
- **Slock `/role move` 跨群迁移 + L1 记忆保持** — 实现 AC11 最终验收项：(1) `SlockCommandAction.ROLE_MOVE` 枚举 + `/role move <name> <target>` 解析；(2) `AgentRegistry.move_agent()` 原子更新 `owner_group`/`member_groups`（L1 memory 按 agent_id 寻址无需迁移）；(3) `build_agent_move_notification_card()` 通知目标群；(4) handler `move_role()` 编排：权限校验→IDLE 状态门控→find_team→registry.move→memory.update_context→send 通知卡→reply 确认。新增 12 核心测试 + 4 并发测试，全量 7529 passed → [详细记录](2026-05-19.md)

## 2026-05-18
- **Slock 存储目录改回全局 `~/.ghostap`** — Slock 运行态、群 marker、Agent 记忆、任务看板默认不再写仓库或项目本地 `.ghostap/slock`，统一放到既有全局配置目录 `~/.ghostap/slock`；`activate_channel()` 停止写仓库 `slock/{chat_id}` legacy marker，`.gitignore` 增加 `slock/`，并从 git 索引移除已误提交的本机群 marker。测试可通过 `SlockEngineManager(storage_base_path=...)` 使用临时配置目录。
- **Slock `/team status` Schema V2 action 容器修复** — `/team status ghostAp` 失败根因为 status panel 仍输出旧版 `{"tag": "action"}`，飞书 Schema V2 返回 `230099/200861 unsupported tag action`。现在 Refresh/Stop 按钮改为 `build_responsive_layout()` 生成合法 `column_set` 布局，并为 callback 按钮补齐 `behaviors`；新增全卡递归测试防止 `action` tag 回归。验证：红灯 1 项后转绿，Slock 相邻回归 `136 passed`，ruff/`--validate`/`git diff --check` 通过。
...
- **Slock README 与帮助入口补齐** — 将 Slock 纳入 README 的引擎总览、消息路由、核心模块、命令参考和项目结构；主 `/help` 新增 Slock 分区，`/slock help` 补充 `--template`、`--fork`、自动任务分配、quoted assign 与 Kanban 用法。验证：帮助卡/Slock 帮助定向回归 `2 passed`，文档引用回归 `4 passed`，ruff 与 `git diff --check` 通过。
- **Slock 文档方案完整落地补齐** — 按飞书方案 revision 42 复核并补齐 Slock 操作层/进化层缺口：`/slock` 激活注册 managed chat、默认 autonomous Directive + L1 `MEMORY.md`、JSONL 消息归档、Kanban 任务状态卡、跨团队 `tool:model:role` 身份与 `member_groups`、Admin `/team list/status/dissolve` 跨团队查找、无角色 `/task assign` 自动技能分配、任务看板持久化、团队 workspace 元数据、技能画像反馈、空闲 Agent 观察学习、agent-scoped 并行 ACP session、全局 agent template market 与 `/new-role --template/--fork`。注意：当时落地为项目本地 `.ghostap/slock`，后续已纠正为全局 `~/.ghostap/slock`。验证：Slock 专项 `298 passed`，ruff/`--validate`/`git diff --check` 通过，全量 `7035 passed, 1 skipped` → [详细记录](2026-05-18.md)
- **Slock 模式 16 项 AC 全量验证通过** — 审计 AC-01~AC-14 现有测试覆盖，发现 AC-09（memory 集成链路）、AC-11（auto_approve 抑制）、AC-14（路由优先级）3 处 gap，补充 7 个测试；新增 `test_validate_cli.py` 2 个 subprocess 测试覆盖 AC-16。全量 `6832 passed`（+9），`--validate` 退出码 0，16 项 AC 全部 PASS → [详细记录](2026-05-18.md)
- **Slock 增强：deactivate/stop、quoted assign、callbacks** — 实现 14 项任务计划：`engine.deactivate()` + `is_active` 属性实现引擎停止生命周期；`SlockCommandAction.STOP` + `/slock stop` 解析；`_parse_assign_args()` 使用 `shlex.split()` 支持 `/task assign "multi word" "Role"` 引号解析；handler `_create_callbacks()` 返回实际 `SlockEngineCallbacks`（on_agent_wake/running/done/error）；`stop_slock_engine()` 调用 `engine.deactivate()` 后注销管理。新增测试：E2E 集成、TaskClaim TTL 压测（50ms/10线程/5×100循环）、L2 记忆隔离（跨 chat_id/10 groups/L1-L2 命名空间）、deactivate 生命周期（7 tests）、quoted assign 解析（9 tests）、callbacks 验证（4 tests）。全量 `6902 passed`，`--validate` 退出码 0
...
- **Active task 蓝条补当前任务名** — 执行阶段蓝色 active tool 条如果 `task` 工具自身没有真实 description/content，之前只显示 `⏳ task`。现在 `flatten_to_atoms()` 会从 `TaskListBlock.current_task_id` 找当前任务名，并仅在 active `task` 摘要为空/泛名时补成 `⏳ **task：<当前任务>**`，不覆盖 tool 自带描述；红灯复现后相关回归 `1 + 55 passed`，全量 `6610 passed`，改动文件 `ruff`、`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **Spec 思考块折叠与完整展示** — Spec 卡片里的“思考完成/深度思考中”块改为工具调用同款 `collapsible_panel`：active 默认展开，completed 默认折叠，完整模式展示全文不再按 reasoning tail 截断；精简模式在分页前把 reasoning atom 压到 222 字以内（含省略号）。reasoning atom 可分页并复用 Markdown split guard，避免长思考全文跨页后污染卡片解析；相关回归 `15 + 139 + 122 passed`，全量 `6609 passed`，改动文件 `ruff`、`--validate` 与 `git diff --check` 通过；全仓 `ruff check` 仍被既有 `scripts/run_stress_test.py` 阻断 → [详细记录](2026-05-16.md)
- **Activity digest 工具调用分类文案** — 完成工具聚合面板里未知工具原先显示为“其他调用”，用户要求先明确增加“工具调用”分类，后续再扩展 skill 技能调用。现在未归入探索/搜索/编辑/命令/失败的 completed tool blocks 统一显示为“工具调用”，保留现有细分分类不变；相关回归 `5 + 136 passed`，全量 `6606 passed`，`ruff`、`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **分页切断 Markdown 上下文修复** — 前一轮 active streaming guard 只能保证单个 active text 当前帧闭合，长内容分页后仍可能把一个 fenced code block 或 inline code span 切到两张 Feishu 卡片里，导致每张卡片各自解析时出现源码、标题、正文混排。现在 pagination 在拆分 text atom 时会补齐第一页的 closing delimiter，并在下一页重开相同 Markdown 上下文，使每页卡片都可独立解析；相关回归 `27 + 227 passed`，全量 `6606 passed`，`ruff`、`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **Active Markdown 流式中间态闭合保护** — 长时间流式卡片仍会短暂出现大段灰底 inline code/代码块错乱，但后续有概率恢复；这不是 RepoLock/ACP/首卡问题，而是 active `element_content` 中模型尚未输出 closing backtick/fence 时，Feishu 会把后续全部按代码解析，等后续帧补齐 delimiter 才恢复。现在 renderer 只对 active streaming text 临时闭合未完成的 code fence 和 inline backtick，completed blocks 保留模型原文，避免中间帧污染后续正文；相关回归 `12 + 217 passed`，全量 `6603 passed`，`ruff`、`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **Deep/Spec 首卡启动延迟修复** — 日志显示最近一次 `/deep` 17:41:34 收到消息，17:41:35 已进入 Deep 并创建 ACP session，17:41:37 session ready，但直到 17:42:49 才创建 delivery pool/首张卡片；慢点不在 RepoLock 或 ACP 启动，而是 Deep processor 未绑定 `on_analyzing_start`，首卡等到模型产生执行信号后的 `on_analyzing_done` 才派发。现在 Deep 在 `on_analyzing_start` 立即派发 Spec-style started/cycle/phase 首卡，`on_analyzing_done` 只做幂等兜底；顺带确认 Spec 也未绑定 analyzing-start，已改为先发“正在分析需求”首卡，done 时追加分析完成内容。相关回归 `4 + 52 passed`，全量 `6600 passed`，`ruff`、`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **长流式卡片乱序与 Markdown 截断修复** — 现场卡片更新一段时间后出现代码块、标题、正文混排乱序，日志显示同一卡片 payload 持续超过 47KB 并反复进入 `payload_truncator`。根因是 full PATCH 发送的是 guard 后截断 payload，但 `BindingStore.last_text` 记录未截断 active text，后续误判飞书端已有完整内容；截断还可能切开 fenced code block，导致后续 markdown 被吞进代码块/标题；streaming `element_id` 变化也未进入 page signature。现在 page signature 纳入 active `element_id`，delivery 按 guard 后实际 active element content 更新 `last_text`，markdown 截断会闭合 ```/~~~ fence；红灯复现后相关回归 `4 + 111 passed`，全量 `6598 passed` → [详细记录](2026-05-16.md)
- **执行计划卡片块拆行与常展开** — 执行计划面板原先会随 phase 折叠，并在非 running 阶段按 `plan_max_chars` 截断；模型把 `1. ... 2. ... 3. ...` 输出成一段时，飞书卡片也会挤成大段。现在 `render_plan_panel()` 保留工具调用同类的带边框块样式，但固定展开、不截断，并把 inline 编号计划归一化为一行一条；红灯复现后相关回归 `2 + 150 passed`，全量 `6594 passed` → [详细记录](2026-05-16.md)
- **Deep 运行卡片复用 Spec-style pipeline** — Deep 和 Spec 底座同为 `CardSession -> render -> delivery`，但 Deep 运行卡片原先在 `DeepRenderer.create_deep_callbacks()` 内维护独立闭包并直接写 `_main_text` 裸 markdown；Spec 走 `SessionRotator + phase/cycle/task/review` 结构化事件。现在删除 DeepRenderer 内原有运行卡片闭包，新增 `DeepStreamProcessor`：Deep 启动派发 `CYCLE_STARTED + PHASE_STARTED(analyzing)`，计划/工具事件切换到 `PHASE_STARTED(build)`，任务列表/工具面板继续走共享事件；红灯复现后 Deep/Spec/card 相邻回归 `105 passed`，全量 `6593 passed`，`ruff`、`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **Feishu 文本代码块 fence 归一化** — 现场 Deep 卡片把 `\```ProgressCardAccumulator` class)python` 后面的 Python 源码当普通 Markdown 渲染，导致 `# -----`、`**...**`、`__future__` 变成大标题/横线/样式错乱；Spec 卡片较少复现是因为 plan/task/review 多走结构化 block，而 Deep 原始 ACP text 更常直接进入 markdown text block。现在 text renderer 与 element_content active text 统一归一化行首 escaped/dirty fenced code block，相关回归 `1 + 166 passed` → [详细记录](2026-05-16.md)
- **Card renderer 多源文本边界补丁** — 二次审查发现上一轮 renderer 的“相邻短 text atom 合并”兜底会越过已经隔离的 `source_id` block，把 `agent-a` 与 `agent-b` 的最终 Feishu markdown 重新拼到同一个 active element。现在 `_coalesce_adjacent_text_fragments()` 只保留前一块可见长度为 1 的病态碎片兜底，同源连续 chunk 仍由 reducer 的 `append_stream_text()` 合并；红灯复现后相关回归 `8 + 163 passed`，全量 `6589 passed` → [详细记录](2026-05-16.md)
- **飞书官方 CardKit 流式与软换行修复** — 现场 `/deep` 卡片正文仍被 Feishu 渲成短行，上一版把富卡 `streaming_mode + element_content` 判为根因并禁用是错误方向；按飞书开放平台 CardKit 流式更新口径，富卡中的 active markdown 仍应保留 `element_id` 并通过 element content API 传完整当前文本、递增 `sequence`。14:37 复现发生在 14:34 重启后的新服务中，真实根因包括 ACP 文本 chunk 边界换行，以及 `src/acp/client.py` 把不稳定的通用 chunk `id` 当 `source_id`，使 `ACPStreamBridge` 把一个连续输出拆成多个相邻短 TextBlock。现在 renderer 恢复官方 CardKit streaming，`src/card/text_stream.py` 统一折叠软换行，ACP source 提取不再使用通用 `id`，保留列表/引用/表格/代码块/空行/hard break 等结构性换行；行为对齐 `lark-channel-bridge` 的连续状态流累积完整文本再更新卡片模式。相关回归 `11 + 72 + 139 + 223 + 362 + 396 passed`，全量 `6588 passed`，`ruff`、`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **仓库瘦身与 Ruff 基线收口** — 保留 `.Memory` 历史记录，删除过期 `.plans` 和 `docs/superpowers/{plans,specs}` 历史草案，新增 `docs/slim-plan.md` 记录 baseline tag `pre-slim-baseline` 与回滚方式；`tests/test_docs_references.py` 增加删除路径/引用守卫。B019 `CARD_DELIVERY_API_TIMEOUT` 可发现性已补齐到 `.env.example`、README 和 `--validate` 输出，Backlog 清零。TTADK wrapper 运行入口迁到 `src.ttadk.wrapper`，Spec 新调用迁到 `src.spec_engine.utils`，旧 utils 路径保留兼容；Ruff 修复后恢复 `EngineRunState`、`build_review_exception_diagnostics` 等兼容 re-export，并清理 Ruff 产生的无效表达式。最终 `ruff`、`--validate`、定向引用/导入/重构测试、全量 `6579 passed`、`git diff --check` 通过 → [详细记录](2026-05-16.md)
- **普通编程卡片多源 ACP 文本流隔离补齐** — Deep/Spec 的 `ACPStreamBridge` 已按 `source_id` 分流，但普通 `/coco`、`/codex`、`/aiden` 等 `ProgrammingCardSession` 仍使用单 active text block 和单 pending text；红灯复现 `agent-a` 的 `Beta` 被追加到 `agent-b` 中文块形成 `甲Beta乙`。现在普通编程会话也按 `ACPEvent.source_id` 维护 text/reasoning block 映射、活跃来源集合和 per-block pending buffer，硬边界统一 flush/close，source-less 继续走 `main` 兼容旧行为。相关回归 `86 + 142 + 239 + 21 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **Spec 缓存任务状态卡 per-run 操作重排** — `/spec_status` 发现多个缓存任务时不再把任务详情和所有恢复/删除按钮分离展示；新增 `ux/spec-cache-status-card.html` 预览稿，并将 `SpecHandler._show_spec_cache_status()` 改为直接构建 Schema 2.0 卡片：每个 `SpecRunSummary` 是一个独立 `collapsible_panel`，面板头展示 `run_id · status · cycle`，面板内展示更新时间/状态/目标/恢复状态，并把该 run 自己的 `恢复/删除` 按钮放在同一面板内。缺少 `state.json` 的目录型 run 只显示删除。红灯先复现旧卡无 per-run panel，相关回归 `5 + 234 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **Feishu 官方卡片元素/字节上限守卫** — 结合飞书开放平台官方文档确认 Card JSON 2.0 单卡最多 200 个元素/组件，发送/更新卡片内容最大 30 KB；线上 `code=230099; element exceeds the limit` 对应日志中 240/402/293 nodes 超限。根因是 active tool panel、activity digest、subagent dispatch 等 atom 把真实 3-4 个 tagged node 低估成 1，分页前无法避开官方上限；delivery truncator 也没有在节点超限后强制产出低节点 fallback。现在 atom 节点估算按真实结构计数，投递前守卫在 table guard 后继续检查节点数，智能截断后若字节或节点仍超预算则降级为单 markdown compact fallback，并确认低于内部 180 节点/27 KB 和官方 30 KB。相关回归 `6 + 119 + 101 passed`，全量 `6572 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
- **Feishu 流式正文/思考块合并与引用左对齐** — 线上日志显示同一运行窗口多次渲染出 240/404/293 个节点并触发 payload 截断，根因是 `ACPStreamBridge` 把 `TEXT_CHUNK`/`THOUGHT_CHUNK` 软切换当成块结束，导致正文和灰色“思考完成”引用被切成大量 `_turn_N_*` 短块；reasoning 面板两列 spacer 结构还让引用视觉不左对齐，且 atom `node_count=1` 低估真实节点。现在同一逻辑流内正文/思考分别稳定追加，只有工具调用等硬边界才关闭并开启下一组唯一 block id；reasoning 面板改为单列灰底左对齐，节点预算调整为 3，避免分页后再被 delivery 截断。相关回归 `20 + 270 + 21 passed`，全量 `6570 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-16.md)
...
- **Spec/Deep 任务列表去重与任务级飞书卡片默认关闭** — ACP `PLAN_UPDATE` 不再生成重复的 `PlanBlock/执行计划`，统一转成顶部 `TASK_LIST_UPDATED/任务列表`；`CARD_TASK_LEVEL_CARDS_ENABLED` 默认改为 `false`，Deep 单卡模式也不再按任务完成发送 `task_done` card split，避免每个子任务刷一条飞书消息。新增红灯回归，相关子集 `6 + 239 + 141 passed`，全量 `6549 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-15.md)
- **Spec 阶段切换误封存与过早完成表情修复** — 现场日志显示第 1 轮 `spec` 阶段完成后仍继续进入 `plan/task/build`，但卡片已绿色完成并停止更新。根因是 `SpecRenderer.notify_cycle_change()` 把 phase/perspective 切换当成 `CARD_SPLIT` 发给 `SessionRotator`，导致当前 `CardSession` 被 `completed` 终态化却没有真正 rotate。现在 Spec phase 切换只更新同一 cycle 卡，cycle 边界继续由 `SessionRotator.rotate()` 归档旧卡；成功表情只在 Spec 项目整体完成时触发。相关回归 `37 + 75 passed`，`--validate` 与 `git diff --check` 通过，服务已重启到 PID 51399 → [详细记录](2026-05-15.md)
- **Feishu 卡片终态总耗时口径修复** — 终态 footer 原本用 `progress_started_at` 计算 `duration_seconds`，导致无 progress 的卡片总耗时为空，progress 晚开始的 Spec/Deep 卡片完成后总耗时偏短。现在 lifecycle reducer 优先用 `CardMetadata.session_started_at + event._now` 计算会话级总耗时，仅在缺少 session 起点时回退 progress 起点；新增红灯回归，全量 `6546 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-15.md)
- **任务列表 JSON 清洗与子任务完成表情修复** — ACP `task/agent/subagent` content 可能是统一执行事件 JSON，旧逻辑直接取第一行导致任务列表/header/summary 出现 `{`、raw JSON 和 stdout；子任务 completed 还会触发 `PARTY`，在整体任务仍运行时语义错误。现在新增 `src/card/tool_display.py` 统一把 `parsed_cmd/command/path/query` 等结构化 payload 转成可读动作摘要，Deep/普通编程子任务、计划任务名和工具状态入卡片前都复用清洗，子任务 completed 不再发送成功 reaction；全量 `6544 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-15.md)
- **SMART shell 跨群 repo lock 绕过修复** — 今日日志显示一个群持有 `/data00/home/jiataorui/work/ghostAp` repo lock 时，另一个群的 SMART shell 仍继续执行，`SandboxExecutor` 只在 `SANDBOX_STRICT_LOCK_MODE=false` 默认下输出 sentinel warning。现在 `SystemHandler.execute_shell_and_reply()` 在执行 shell 前复用 handler `_with_repo_lock()`，冲突时发送已有 repo lock conflict card 并不调用 `SandboxExecutor.execute()`；红灯回归已变绿 → [详细记录](2026-05-15.md)
- **今日代码巡检缺陷收口** — 评审发现 plan 模式泛名 `task` start 会先创建 orphan child 卡、terminal retry 成功会把 failed/cancelled hook reason 写成 completed、Feishu timeout 后仍复用旧 binding 且 SDK worker 无上限。现在泛名 task 等真实描述再绑定 plan task，terminal retry 保留真实 reason，update/element timeout 后丢弃旧 binding 并重建，Feishu SDK worker 增加进程级 slot 上限；新增 4 个红灯回归，相关子集 `25 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-15.md)
- **Feishu 编程卡片中途停更/无终态兜底修复** — 现场日志显示 11:46 普通 Codex 任务进入 `session.send_prompt()` 后应用日志无完成记录，但 Codex JSONL 仍持续产出事件；卡片投递链路中 Feishu SDK 调用一旦长期不返回，会占住 `CardDelivery` 同一 session 锁，后续更新和终态只能挂在 pending。现在 `FeishuCardAPIClient` 对所有 Feishu API 调用增加 35s 硬超时，终态 `reconcile` 不再被当成功投递而是进入重试/文本兜底，普通编程主卡补齐 `reply_text_fn`，卡片事件处理异常升为 warning。相关回归 `10 + 160 passed`，`--validate` 通过 → [详细记录](2026-05-15.md)
- **Deep/普通编程泛名 task 卡片延迟改名修复** — ACP `task` 工具调用如果 start 只有泛名 `task`、真实描述到 update 才出现，独立子任务卡原本会一直显示“子任务/task”。现在 `TaskOrchestrator` 和 `ProgrammingCardSession` 都会在后续非 done 工具事件中用真实描述更新任务卡 `unit_label`；`TOOL_MODEL_CHANGED` 同步支持 `unit_label`，并修正纯 live ticker 帧不再误 bump `structural_version`。相关回归 `9 + 44 + 35 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-15.md)
...
- **Feishu 自动 reaction 收敛但保留任务生命周期反馈** — 自动表情白名单从仅 `Typing` 修正为 `Typing`、`OnIt`、`PARTY`：保留处理中、收到任务、任务完成三个用户可感知反馈，同时继续过滤 `OK`、`Fire`、`SOB` 等噪音表情；`BaseHandler.add_reaction()` 与 `FeishuIMClient.add_reaction()` 仍双出口兜底。相关回归 `3 + 17 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-15.md)
...
- **任务卡准并行独立更新落地** — `TaskOrchestrator` 状态刷新从“任一任务状态变化就给所有任务卡广播 `TASK_LIST_UPDATED`”改为“pending task id 定向刷新对应任务卡 / overflow 承载卡”：每张任务卡仍通过自己的 `CardSession` 独立投递和合并更新，普通任务状态变化不再拉着其他任务卡一起 PATCH；子任务进展继续只更新自己的子任务卡。相关回归 `195 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-15.md)
...
- **Deep 子任务卡片冻结与最终汇总卡优化** — Deep 多任务/子任务卡片现在严格按执行边界更新：agent/subagent 子任务注册、运行和完成只更新自己的子任务卡，不再通过 `TOOL_MODEL_CHANGED(subagents=...)` 或 `TOOL_CALL_START` 进度 PATCH 父/最初任务卡；普通计划任务完成/失败后会给对应卡发送终态并从后续任务列表广播中排除；Deep 多卡任务全部完成后通过 `TaskOrchestrator.finish_with_summary()` 新建“任务总结”卡承载最终摘要。回归覆盖父卡不更新、已完成卡冻结、最终汇总新卡；`112 passed` + 相邻 Deep/card `48 passed`，`--validate` 与 `git diff --check` 通过 → [详细记录](2026-05-15.md)
- **Deep 子任务独立卡片路由修复** — Deep 多任务进入 TaskOrchestrator 后，agent/subagent 工具调用不再被合并进最近一个主任务卡片；`TaskOrchestrator.route_acp_event()` 会识别 `agent/subagent` 工具调用或 `子代理：` 标记，为每个 `tool_call.id` 注册独立子任务 CardSession，执行中转发 TOOL_CALL_START/UPDATE/DONE，完成时同步 `completed/failed` 终态。后续优化已取消父卡实时摘要 PATCH，避免子任务进展刷新父卡。新增 orchestrator 与 DeepRenderer 集成回归；相关回归 `151 passed` + Deep/card pipeline `32 passed`，`--validate` 与 `git diff --check` 通过；扩大 `tests/test_deep_engine.py` 中 2 个 TTADK 用例仍因本机缺 `ttadk` 可执行文件失败，和本次卡片路由无关 → [详细记录](2026-05-15.md)
...
- **Spec 缓存任务快捷删除能力** — `/spec_status` 缓存任务卡片现在对列出的 run 提供快捷操作：有 `state.json` 的 run 显示“恢复 <run_id>”，所有 run 显示 danger 类型“删除 <run_id>”。新增 `delete_spec_run()` 删除 `.spec_engine/<run_id>` 并清理匹配的项目级 `.spec_engine_state.json`，防止删除后又被自动补回；运行中的同 id Spec engine 会阻止删除并提示先 `/stop_spec`。Spec 相关回归 `241 passed`，`--validate` 与 `git diff --check` 通过，服务已重启到 PID 88830 → [详细记录](2026-05-14.md)
- **Spec run 恢复缺失 state.json 修复** — `/spec_recover f703e1f3` 失败的根因是该 id 属于 Spec run/project id，而旧恢复入口只查失败任务快照；同时异常停止可能留下项目级 `.spec_engine_state.json` 和 run artifacts，却缺 `.spec_engine/<run_id>/state.json`。现在保存顺序优先写 run state，`list_spec_runs()` / `state_path_for_run()` 会用项目级 state 自动补齐 run `state.json`，`/spec_recover <run_id>` 会 fallback 到 run restore；磁盘 `running` 但当前无运行 engine 时会转暂停并走 resume；真实 `clawcli` 的 `f703e1f3/state.json` 已补齐，Spec 相关回归 `238 passed`，`--validate` 与 `git diff --check` 通过，服务已重启到 PID 82829 → [详细记录](2026-05-14.md)
...
## 2026-05-26
- **Slock 报错集中修复** - 讨论/内存/卡片/任务分配/安全脱敏 → [2026-05-26.md](2026-05-26.md)
...
- 2026-08-10：修复启动审计与历史重放兼容，详见当日日志。

- 2026-08-10：恢复显式模型级联选择并保持任务全自动，详见当日日志。

- 2026-08-10：修复模型选择卡 invalid width，详见当日日志。

- 2026-08-10：闭合选模回调到激活终态全流程，详见当日日志。
- 2026-08-10：移除旧模式引导，隔离 Claude CLI 与 ACP 探测；详见 `.Memory/2026-08-10.md`。
- 2026-08-10：精简配置面并修复签名/权限契约；详见 `.Memory/2026-08-10.md`。
- 2026-08-10：恢复员工 roster 命令/自然语言与全状态卡片；详见 `.Memory/2026-08-10.md`。

- 2026-08-10：隐藏归档员工并增加职责设置命令；详见当日日志。

- 2026-08-10：修复员工后端标识双重转义；详见当日日志。

- 2026-08-10：修复已完成任务的子代理终态误判；详见当日日志。
- **员工待处理启动自愈** - 精确Slash尾原子重开并等待真实终态 → [2026-08-10.md](2026-08-10.md)
- 2026-08-10 员工所有者私聊直达执行；详见 `.Memory/2026-08-10.md`
- 2026-08-10：直聊授权、恢复重试与上下文优先级，详见 `.Memory/2026-08-10.md`。
- 2026-08-10：账本身份与partial预算统一，详见 `.Memory/2026-08-10.md`。
- 2026-08-10：账本窗口完整保留topic，详见 `.Memory/2026-08-10.md`。
- 2026-08-10：恢复锁注解通过全库扫描，详见 `.Memory/2026-08-10.md`。
- 2026-08-10：恢复边界改为terminal对当前epoch，详见 `.Memory/2026-08-10.md`。
- 2026-08-10：Workflow Agent Pool 与会话竞态收口，详见 `.Memory/2026-08-10.md`。
- **员工重启恢复闭环** - crash proof 与遗留 Effect 持久收口 → [2026-08-10.md](2026-08-10.md)
- 2026-08-11：Workflow 完整执行卡与取消终态已落盘，仍有 full-content 隔离阻断；详见 `.Memory/2026-08-11.md`。
- 2026-08-11：普通编程单窗口耗尽改为安全退休、同会话恢复并自动续窗；详见 `.Memory/2026-08-11.md`。
- 2026-08-11：Workflow 生成活动按句段刷新，等待时长改为中文时分秒；详见 `.Memory/2026-08-11.md`。
- 2026-08-11：Workflow 单次生成恢复180秒配置，池内fallback保留预算并吸收ACP关闭迟到帧；详见 `.Memory/2026-08-11.md`。
- 2026-08-11：Workflow选池改为表单批量提交并并行预热，消除逐级慢回调；详见 `.Memory/2026-08-11.md`。
- 2026-08-11：飞书卡片回调仅保留2.0，新版SDK与3秒本地ACK门禁落地；详见 `.Memory/2026-08-11.md`。
- 2026-08-11：补齐card帧回调ACK，修复Workflow模型目录错配；详见 `.Memory/2026-08-11.md`。
- 2026-08-11：Workflow选池恢复模型级联并按最终配置精确去重；详见 `.Memory/2026-08-11.md`。
- 2026-08-13：修复warning投影全扫与退避热循环；详见 `.Memory/2026-08-13.md`。
- 2026-08-13：消除空warning队列的Journal锁竞争误报；详见 `.Memory/2026-08-13.md`。
- 2026-08-13：普通编程取消溯源与一次恢复收口；详见 `.Memory/2026-08-13.md`。
- 2026-08-13：Workflow公平预算与池内自动fallback；详见 `.Memory/2026-08-13.md`。
- 2026-08-13：修复Workflow Claude CLI空闲超时接口；详见 `.Memory/2026-08-13.md`。
- 2026-08-13：修复重启期Slash误隔离与重复恢复；详见 `.Memory/2026-08-13.md`。
- 2026-08-13：WS断链自动恢复日志去重并补恢复耗时；详见 `.Memory/2026-08-13.md`。
- **仓库根目录清理** — 删除缓存、旧运行产物和过期跟踪文件，服务停机待重建环境 → [2026-08-17.md](2026-08-17.md)
- **修改后自动推送** — 每次聚焦提交后必须 push 当前分支，失败不得视为完成 → [2026-08-17.md](2026-08-17.md)
- **uv Python 沙箱挂载** — 修复解释器绝对链接导致 bwrap 启动降级 → [2026-08-17.md](2026-08-17.md)
- **重启分阶段计时** — 区分依赖检查与初始化，冷环境预编译字节码 → [2026-08-17.md](2026-08-17.md)
- **Employee 投影线性重放** — 保留在线原子性并消除恢复 O(n²) 深拷贝 → [2026-08-17.md](2026-08-17.md)
- **Reporting 修复单飞** — 恢复线程与后台线程不再重复发布终态产物 → [2026-08-17.md](2026-08-17.md)
- **Knowledge 增量投影** — 终态恢复复用已验证快照，不再反复全盘重放 → [2026-08-17.md](2026-08-17.md)
- **启动优化端到端验收** — readiness 10秒，员工恢复降至35秒且全量回归通过 → [2026-08-17.md](2026-08-17.md)
